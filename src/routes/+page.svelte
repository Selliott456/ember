...
<main class="home">
    ...
    <div class="product-grid">
      {#each curatedProducts as product}
        <ProductCard
          ...
          title={product.title}
          imageSrc={(product.images?.[0]?.url ?? product.featuredImage?.url) ||
  ...
  <section class="new-drop">
    <div class="new-drop-media">
      <img
        src="/images/badbish_quad_1.png"
        alt="Badbish new drop preview"
        loading="lazy"
      />
    </div>
  ...
  <section class="editorial-banner">
    <img
      src="/images/shoreditch.png"
      alt="Ember lifestyle banner"
      loading="lazy"
    />
    ...
    <div class="lookbook-grid">
      {#each lookbookImages as imageSrc, idx}
        <figure class="lookbook-shot">
          <img
            src={imageSrc}
            alt={`Ember lookbook image ${idx + 1}`}
            loading="lazy"
          />
        </figure>
      {/each}
